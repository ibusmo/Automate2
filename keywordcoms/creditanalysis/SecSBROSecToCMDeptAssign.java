...
public class SecSBROSecToCMDeptAssign extends KeywordsCOM {

	private String CMDeptName;
	
	public SecSBROSecToCMDeptAssign(Controller ctrl, String CMDeptName){
		super.ctrl = ctrl;
...
//			sendToLogCustom(logexestatus.PASS, logaction.Dropdown, ":หน่วยงาน * = เขตวัชรพล");
			...
			sendToLogCustom(logexestatus.PASS, logaction.Checkbox, "มอบหมายงาน :SBRO to SBROSec " + userIndex + "-" + CMDeptName );
